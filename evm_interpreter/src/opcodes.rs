// Unfortunately revm-primitives and revm-interpreter do not build under no_std due to their dependency chains
// (hex, byteorder, proptest), so we just include https://github.com/bluealloy/revm/blob/main/crates/interpreter/src/instructions/opcode.rs
...
#[derive(Debug)]
pub struct OpInfo {
    /// Data contains little information packed inside u32:
